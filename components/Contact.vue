...
<template>
    <main>
        <div>
            <b-img src="https://jcmatao.com.br/wp-content/uploads/2019/06/Fatec-660x330.jpg" fluid-grow alt="Fluid-grow image"></b-img>
        </div>
        <h2>Acompanhe a <strong>Fatec Matão:
          ...
          <a href="https://www.youtube.com/channel/UCm7alSqweOyoJ67G1eM8f0A">
		  	<img src="../static/icons/icons8-reproduzir-youtube.svg" alt="YouTube">
		  </a>
          </strong>
        </h2>
    </main>
